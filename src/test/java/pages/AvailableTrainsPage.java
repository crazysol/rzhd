...
public class AvailableTrainsPage extends AbstractWebPage{

	Common common = new Common();
	
	public AvailableTrainsPage(WebDriver driver){
		super(driver);
	...
	public void uncheckCheckboxesAndClickRecalculate(){
	...
	public void getResultsAndWriteToFile() throws IOException{
